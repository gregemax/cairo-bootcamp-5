...
const deployScript = async (): Promise<void> => {
  buns_token = await deployContract({
    ...
    constructorArgs: {
      ...
      owner:
        "0x00b347f940bCFA9C75cA56d0a0fa2A054dfa93D73D4CD3A4145ff98D65b746D5", // In devnet, your deployer.address is by default the first pre-deployed account: 0x64b48806902a367c8598f4f95c305e8c1a1acba5f082d294a43793113115691
    },
  });
  ...
  dex = await deployContract({
    ...
    constructorArgs: {
      ...
      owner:
        "0x00b347f940bCFA9C75cA56d0a0fa2A054dfa93D73D4CD3A4145ff98D65b746D5",
    },
  });
};
...
const transferScript = async (): Promise<void> => {
  try {
    ...
    console.log(
      "Approve token and strk transaction hash:",
    ...
    console.log(
      "DEX Initialization Completed at ",
      initResponse.transaction_hash
    );
  ...
  try {
    ...
    console.log(
      `Frontend address ${frontEndAddress} $BAL balance: ${BigInt(
        recipientBalance[0]
      )} in fri`
    );
  } catch (error) {
